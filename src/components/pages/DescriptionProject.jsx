    ...
    return(
        <div className={styles.project__wrap}>
            <div className={styles.project__description_headdedr}>
                <Link to='/MyPortfolio/' className={styles.project__description_headdedr_link}>&lt; Back</Link>
                <Link to='/MyPortfolio/project' className={styles.project__description_headdedr_link_mobile}>&lt; Back</Link>
